...
//! - [`polyphonic`] multi-pitch estimation by harmonic-sum salience;
//! - [`envelope`] amplitude envelopes and the velocities derived from them; and
//! - [`tempo`] autocorrelation tempo and beat-phase estimation.
...
pub use tempo::{Tempo, TempoOptions};
